...
| --- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | How do students think about the workload for Prof Dodis's fundamental algorithm course?                         | Students generally describe Prof. Dodis's Fundamental Algorithms workload as heavy. Reviews mention long weekly homework, tedious assignments, long exams, and a difficult course, although at least one review says the work is worthwhile for learning algorithms.                                                                                          |
| 2   | Why are the reviews of Prof Yap's students so polarized?                                                        | Yap's reviews are polarized because some students praise him as responsible, caring, responsive, and helpful in office hours, while others criticize boring lectures, confusing or poorly written materials, mistakes, difficult homework, and unclear grading expectations.                                                                                  |
| 3   | Which professor's course uses a grading curve?                                                                  | Franke's Operating Systems course clearly uses a grading curve, with multiple reviews mentioning generous curves for exams/midterms/finals. Yap's Fundamental Algorithms also has at least one review mentioning curved grading. Bethe is mentioned as refusing to curve scores.                                                                              |
| 4   | What are the main complaints students have about Prof Bethe's class?                                            | The main complaints about Bethe's class are poor preparation, confusing or unorganized lectures, bad or missing slides, useless notes, wrong blackboard work, difficult homework/labs/projects/exams, low class averages, and refusal to curve grades.                                                                                                        |
| 5   | If I want to learn operating system, what's the difference between Prof Tang's course and Prof Franke's course? | Both Tang and Franke teach Operating Systems, but Tang's reviews emphasize clear materials, engaging lectures, caring/helpful teaching, and useful labs, while Franke's reviews are more mixed: some praise rich lectures/helpful labs/generous curves, while others criticize rushed lectures, difficult exams, confusing lab specs, and reliance on curves. |
